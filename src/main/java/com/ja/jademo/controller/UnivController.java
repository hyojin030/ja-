...
public class UnivController {
    ...
    @GetMapping("/univ")
    public String univ(Model model, @RequestParam(required=false) Long id, @PageableDefault(size=10) Pageable pageable, @RequestParam(required = false, defaultValue = "") String searchtext){
